...
abstract: I originally built this portfolio site back in 2023, and since then it's evolved quite a bit. Recently I migrated from Create React App to Next.js and made some major upgrades in the process.
date: '2023-12-11'
...
In 2023, at the age of 22, I embarked on the journey of creating my portfolio website, a digital canvas that reflects my passion and dedication to the world of web development. As an aspiring full stack developer, I aim to stand out in the ever-evolving tech landscape by showcasing my proficiency in both frontend and backend engineering. This portfolio is more than a collection of projects; it's a testament to my relentless pursuit of excellence. Through my portfolio, I strive to demonstrate my ability to craft immersive and visually captivating user experiences, backed by robust, efficient, and scalable backend systems. With this digital platform, I aim to leave a lasting impression, inviting opportunities, collaboration, and networking with fellow developers, all while leaving a mark on the digital frontier.
